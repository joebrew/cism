...
#'
#' Fetch a table or a specific query of a table from a CISM database.
#' @param query A mysql query as a chracter string of length 1
...
#' Examples include "openhds", "dss", "maltem_absenteeism", etc. If \code{NULL}
