...
# # Load datafrom zambezia
# # Saved via
# save(vv, vvb, vvb_ll_spray, vvb_spray, vv_ll, vv_spray, vv_spray_ll, census_spatial_ll, village_df, census_spatial, mop_ll, vvb_ll, 
#      file = 'data/census.RData')
# census_spatial@data <-
#   census_spatial@data %>%
